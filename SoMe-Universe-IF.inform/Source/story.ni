...
The Archaeology Recruiter is a man in the Disease Citadel. "Under the Archaeology Division's banner stands a floor-to-ceiling column of pressurized vent-fluid, and inside it floats the Division's living billboard: a resurrected ancestor - a waxy, filamentous mat-thing older than oxygen, sulfur crystals growing on its skin in real time, purple membrane patches catching the light like oil on water." The description is "An Archaea, woken from a viable sample by the Division's sequencers and asked to volunteer. It predates gender, nerves, and every verb you use for talking; the translators render its membrane-flickers as speech. A brass plate under the column reads: EXHIBIT ZERO - DO NOT STOP THE FEED." Understand "ancestor" and "archaea" and "resurrected ancestor" and "exhibit zero" and "mat" as the Archaeology Recruiter.
...
Instead of asking the Archaeology Recruiter about something when the topic understood matches the regular expression "^secret|gut|methane|host$":
	say "The membrane flushes violet - the archaeal smile. 'A secret, envoy, kept in your own body: you never stopped hosting us. Methanogens ride your gut to this day; every quiet bubble of methane you have ever produced was signed by my lineage. You did not discover the ancestors. You merely stopped reading the receipt. And there are more of us in the Division's sample vaults - viable, patient, waiting for the sequencers to reach their shelf.'";
Instead of asking the Archaeology Recruiter about something when the topic understood matches the regular expression "^tech|technology|forerunner|covenant|aaa|accord|rival$":
	say "'Your Accord levels our dig sites and calls it containment,' it says, unbothered. 'We re-dig them twice as well in the dark. The catalogue of what waits: sulfur metabolism for the oxygen-poor war. Halophilic armor for the salt flats. Taq polymerase and reverse gyrase so fever cannot edit us. Methanogenesis to fight in the anaerobic gut of a continent. The Division does not worship the ancestors, envoy. It does the paperwork of waking them.'";
