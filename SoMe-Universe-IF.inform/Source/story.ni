...
The Archaeology Recruiter is a man in the Disease Citadel. "Set into the floor beneath the Archaeology Division's banner is a ringed vent-pool, its water mirror-still and faintly amber - and out of it, half-risen, hangs something that is not a man: a resurrected ancestor, a mat-thing older than oxygen, wax-grey and filamentous, sulfur crystals budding on its skin in real time, purple membrane patches rippling like oil on water." The description is "An Archaea, woken from a viable sample by the Division's sequencers and asked to volunteer. The pool is its umbilical: heated water cycles up from the deep pipes, and the mat rides the updraft, surfacing and sinking at will, never quite leaving home. It changes height when you are not watching: sometimes knee-high out of the water, sometimes at your eye. The hall's air goes warm and faintly sulfurous wherever it lingers. It predates gender, nerves, and every verb you use for talking; the translators render its membrane-flickers as speech." Understand "ancestor" and "archaea" and "resurrected ancestor" and "mat" and "mat-thing" and "pool" and "vent-pool" as the Archaeology Recruiter.
