...
The Archaeology Recruiter is a man in the Disease Citadel. "Something that is not a man drifts across the Archaeology Division's banner without touching the floor: a resurrected ancestor - a mat-thing older than oxygen, wax-grey and filamentous, sulfur crystals budding on its skin in real time, purple membrane patches rippling like oil on water. It has left its vent-fluid column open behind it, an empty doorway of steam." The description is "An Archaea, woken from a viable sample by the Division's sequencers and asked to volunteer - and it walked out of its feed-column to do the recruiting personally. It changes height when you are not watching: sometimes knee-high, sometimes at your eye. The hall's air goes warm and faintly sulfurous wherever it lingers. It predates gender, nerves, and every verb you use for talking; the translators render its membrane-flickers as speech." Understand "ancestor" and "archaea" and "resurrected ancestor" and "mat" and "mat-thing" as the Archaeology Recruiter.
