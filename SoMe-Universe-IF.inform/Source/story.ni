...
The Archaeology Recruiter is a man in the Disease Citadel. "Under the Archaeology Division's banner stands something that is not a man, wearing no container at all: a resurrected ancestor, a mat-thing older than oxygen, wax-grey and filamentous, its surface armored in a self-mineralized crust of sulfur and iron pyrite - fool's-gold plate grown from its own cell walls. Behind it, on a hand-truck, an empty transport vat waits with its hatch open, already redundant." The description is "An Archaea, woken from a viable sample by the Division's sequencers and asked to volunteer. It needs no vat, no feed, no life support: its own S-layer wall mineralizes into armor wherever the air is hostile, and it carries its home chemistry inside itself, the way it has for four billion years. The empty vat is a convenience for samples too young to armor - this one is old enough to dress itself. It changes height when you are not watching: sometimes knee-high, sometimes at your eye. The hall's air goes warm and faintly sulfurous wherever it lingers. It predates gender, nerves, and every verb you use for talking; the translators render its membrane-flickers as speech." Understand "ancestor" and "archaea" and "resurrected ancestor" and "mat" and "mat-thing" as the Archaeology Recruiter.

The Fear Recruiter is a woman in the Disease Citadel. "Under Fear Technology's banner stands a composed woman with a clipboard of containment schedules, a drone circling her shoulder like a tame wasp, and behind her, half in shadow, a steel door with a hatch and a warning stripe." The description is "The Site supervisor of the Fear Technology Division - the one who signs the feeding sheets. Her lanyard reads SITE-66 / CONTAINMENT / DO NOT APPROACH THE DOOR WITH AN EXPECTATION. Her expression never changes; the drone's shadow, somehow, always falls across your eyes." Understand "director" and "site supervisor" and "supervisor" and "containment" as the Fear Recruiter.
...
Instead of asking the Archaeology Recruiter about something when the topic understood matches the regular expression "^join|joining|patron|banner|swear|oath|why|who are you$":
	say "The mat-thing changes height without preamble - knee-high, then at your eye - and the air around you goes ammonia-bright and warm. 'You are looking for the tank. There is no tank. I am wearing my own chemistry, envoy - the crust you see is my cell wall, mineralized. Kill the power to a thousand vats and their sleepers wake annoyed, not dead. We invented surviving, and we did it without plumbing.' The air around it warms. 'Before your oxygen, we were. Your kind files us under extremophile - a word meaning life that embarrasses your chemistry.' A single filament separates from the mat and hangs in the air before your eyes, purple membrane patches blooming and re-rippling along it in real time. 'Watch: reverse gyrase. Fever cannot unravel my letters. Acidity of pH one is my bath. One hundred thirteen degrees is my afternoon. Your Division digs for us the way the old fiction's covenant dug for its forerunners - everything you call technology, we call metabolism. Join, and dig us up. Wake more of us. We teach what oxygen forgot.'";
