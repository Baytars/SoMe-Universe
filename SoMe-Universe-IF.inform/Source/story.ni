...
Carry out choosing a patron:
	...
	otherwise if the lowered matches the regular expression "^(vibrio|abyssal|octopus|admiral|cholera)( or .*)?$":
		say "The heart-core dims its tank to abyssal black, and the eight cannon-bores seal like eyes going to sleep. 'Water is life, water is death,' it says. 'Take the water away and we are a museum exhibit - so we never let it be taken. Welcome to the water, envoy.' You swear to the Abyssal Legion.";
...
The Vibrio Recruiter is a man in the Disease Citadel. "Under the Abyssal Legion's banner stands a floor-to-ceiling seawater tank, and inside it floats the thing they sent to recruit: an armored tentacle of the Cholera Octopus itself, metal-biological fusion, deep blue-green with cold bioluminescence - the flagship's own heart-core, here in a column of its home ocean." The description is "A living limb of the fifty-meter flagship, cut from the Octopus and kept alive as an embassy. Eight suction-crown bores line its length - each one a critical-pressure hydro-cannon mouth. When it speaks, the water in the tank shivers in rhythm with its voice." Understand "octopus heart" and "heart-core" and "tentacle" and "flagship" as the Vibrio Recruiter.
...
Instead of asking the Vibrio Recruiter about something when the topic understood matches the regular expression "^join|joining|patron|banner|swear|oath|why|who are you$":
	say "The tank brightens; the limb drifts closer, and the glass fogs from the inside. 'You stand before the heart-core of the Cholera Octopus, envoy - fifty meters of metal-biological armor, eight tentacles, eight hydro-cannons, one mind. Below the shallow scouts and the mid-depth berths our abyssal fortress descends four thousand meters: drill-factories, geothermal stations, a city your maps spell Atlantis. We do not board ships. We flood the field, boil it, and own the sea it stood on. Join the Legion, and the ocean becomes a weapon with your hand on the valve.'";
Instead of asking the Vibrio Recruiter about something when the topic understood matches the regular expression "^secret|cannon|cphc|pressure|water$":
	say "A tentacle bore dilates against the glass - a mouth within the mouth. 'A secret, freely shown. Our cannon does not fire shells. It fires water driven past its own critical point: the jet is no longer liquid, the pressure is four hundred atmospheres past steel, and where it lands the cavitation bubbles collapse at ten thousand degrees. Your Accord armor fails from the inside out. There is no counter except distance - and we own the distance.'";
Instead of asking the Vibrio Recruiter about something when the topic understood matches the regular expression "^chlorine|weakness|drain|counter$":
	say "The bioluminescence dims, deliberately. 'You are fishing for weaknesses. Honest, then: heat cooks us, chlorine unmakes our hide, drain the water and we are a museum exhibit. Now weigh that against the price of getting close enough to try. The Legion prints its vulnerabilities in its own doctrine, envoy - because by the time you reach them, you are already standing in our ocean.'";
