...
Instead of asking the Vibrio Recruiter about something when the topic understood matches the regular expression "^secret|cannon|cphc|pressure|demonstration|show$":
	say "She looks at you for the flicker of a smile - and finds none. '...Okay. Wrong toy.' From under the skirt hem she unhooks what is unmistakably a child's water pistol: orange plastic, a tank the size of a teacup, a trigger guard painted like a dolphin. 'Standard issue, Legion sidearm. Single shot - watch the floor, not me.' She aims at the mosaic tiling by the door and squeezes.
The jet is invisible. The floor is not: a fist-sized patch of mosaic simply ceases - tile, grout, a hand's depth of substrate - punched into powder, and the air snaps shut behind it with a thunderclap of collapsing cavitation, droplets raining warm as breath. Ten thousand degrees for a blink, in a hole the size of a coin.
'Critical-pressure hydraulic cannon,' she says, spinning the pistol once around her finger and re-holstering it under the skirt. 'It fires water, envoy. Water. The flagship's cannons are the same gun, nine sizes up. There is no counter except distance - and we carry the distance with us.' The smile comes back like a mask going back on. 'Gum?'";
