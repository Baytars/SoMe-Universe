...
The Archaeology Recruiter is a man in the Disease Citadel. "Parked under the Archaeology Division's banner on a hand-truck sits a pressurized transport vat - a squat steel cylinder with a riveted hatch, a pressure gauge, and a heating coil humming at vent temperature - and out of its open hatch hangs something that is not a man: a resurrected ancestor, a mat-thing older than oxygen, wax-grey and filamentous, sulfur crystals budding on its skin in real time, purple membrane patches rippling like oil on water." The description is "An Archaea, woken from a viable sample by the Division's sequencers and asked to volunteer. The vat is its field kit: heated, pressurized, plumbed to a backpack condenser, and rolling on two solid wheels - because the ancestors come to the recruiting post the same way they came through four billion years, in the sturdiest available container. The mat rides the vat's updraft, surfacing and sinking at will. It changes height when you are not watching: sometimes knee-high, sometimes at your eye. The hall's air goes warm and faintly sulfurous wherever it lingers. It predates gender, nerves, and every verb you use for talking; the translators render its membrane-flickers as speech." Understand "ancestor" and "archaea" and "resurrected ancestor" and "mat" and "mat-thing" and "vat" and "transport vat" and "hand-truck" as the Archaeology Recruiter.
